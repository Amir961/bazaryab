...
class ListStateWidget extends StatefulWidget {
  ...
  const ListStateWidget({super.key,required this.context});
...
class _ListStateWidgetState extends State<ListStateWidget> {
  ...
  start()async
  {
    ...
    if(BlocProvider.of<AddCustomerBloc>(widget.context).state.listState.isEmpty) {
      BlocProvider.of<AddCustomerBloc>(widget.context).add(GetStateEvent());
    }
    else {
  ...
  Widget build(BuildContext context) {
    return
      ...
      SafeArea(
        ...
        value: BlocProvider.of<AddCustomerBloc>(widget.context),
        child:
        SizedBox.expand(
          child: Stack(
            children: [
  ...
  Widget get _listView => BlocConsumer<AddCustomerBloc,AddCustomerState>(
      ...
      listener: (context,state){
       ...
       else if(state.statusButtonGetState== StatusButton.success)
        {
          ...
          originList=BlocProvider.of<AddCustomerBloc>(widget.context).state.listState;
          tempList=List.from(BlocProvider.of<AddCustomerBloc>(widget.context).state.listState);
