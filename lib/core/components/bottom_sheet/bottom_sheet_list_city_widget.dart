...
class ListCityWidget extends StatefulWidget {
  ...
  const ListCityWidget({super.key,required this.context,required this.id});
  ...
  Widget get _listView => BlocConsumer<AddCustomerBloc,AddCustomerState>(
      ...
      listener: (context,state){
       ...
       else if(state.statusButtonGetCity== StatusButton.success)
        {
          ...
          originList=BlocProvider.of<AddCustomerBloc>(widget.context).state.listCity;
          tempList=List.from(BlocProvider.of<AddCustomerBloc>(widget.context).state.listCity);
